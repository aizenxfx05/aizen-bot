...
from discord import *
import discord
from utils.emoji import BOOST, ICONS_WARNING, INFO, MENTION, PREMIUM, TICK, TIME, TIMER_ALT1, U_ADMIN, ZDIL, ZHUMAN, AIZEN_HAMMER, AIZEN_SYS
import aiosqlite
                ...
                for user_id in expired_users:
                    ...
                    f"**Removed By**: **{BotName}**\n"
                        ...
                        support = Button(
                            ...
                            url=f"https://discord.gg/M8qJ9W7vBb",
                        )
                        view = View()
