      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#07070D]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-4 group">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#A855F7] to-[#6D28D9] flex items-center justify-center mr-3">
          ...
          <div className="hidden lg:flex items-center w-80 relative group">
            <SearchIcon className="absolute left-4 h-4 w-4 text-[#382F48] group-focus-within:text-[#A855F7] transition-colors" />
            <input
              type="text"
