...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#050508] text-[#FAFAF9] selection:bg-[#EAB308]/30 font-sans overflow-x-hidden">

      {/* ── Dynamic Gold Background ──────────────────────────── */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-20%] left-[-10%] w-[70%] h-[70%] bg-[#EAB308]/[0.03] blur-[180px] rounded-full animate-pulse" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-[#A16207]/[0.025] blur-[150px] rounded-full animate-pulse [animation-delay:2.5s]" />
        <div className="absolute top-[40%] left-[40%] w-[40%] h-[40%] bg-[#EAB308]/[0.015] blur-[120px] rounded-full animate-pulse [animation-delay:5s]" />
      </div>

      {/* ── Navigation ───────────────────────────────────────── */}
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#050508]/80 backdrop-blur-3xl transition-all duration-500">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 group cursor-pointer">
            <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-[#EAB308] to-[#92400E] flex items-center justify-center shadow-lg shadow-[#EAB308]/20 border border-white/10 group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
              <Bot className="h-6 w-6 text-[#050508]" />
            </div>
            <div className="flex flex-col">
              <h1 className="text-lg font-bold tracking-tight text-white font-outfit leading-none">{BRAND}</h1>
              <span className="text-[9px] font-black uppercase tracking-[0.25em] text-[#EAB308]/80 mt-1">Dashboard</span>
            </div>
          </div>

          <div className="hidden lg:flex items-center gap-10 text-[11px] font-black uppercase tracking-widest text-[#78716C]">
            <Link href="#features" className="hover:text-[#EAB308] transition-colors">Features</Link>
            <Link href="#architecture" className="hover:text-[#EAB308] transition-colors">Architecture</Link>
            <Link href="#modules" className="hover:text-[#EAB308] transition-colors">Modules</Link>
            <Link href="#network" className="hover:text-[#EAB308] transition-colors">Network</Link>
          </div>

          <Button
            onClick={() => signIn("discord", { callbackUrl: "/dashboard" })}
            className="rounded-xl px-7 h-11 font-black uppercase tracking-widest text-[10px] gap-2.5 shadow-2xl shadow-[#EAB308]/20 hover:scale-[1.05] active:scale-95 transition-all bg-gradient-to-r from-[#EAB308] to-[#92400E] text-[#050508] border-none"
          >
      ...
      <header className="relative z-10 pt-56 pb-32 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          {/* Status Badge */}
          <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-2xl bg-[#EAB308]/[0.04] border border-[#EAB308]/15 text-[#EAB308] text-[10px] font-black uppercase tracking-[0.3em] mb-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 backdrop-blur-md">
          ...
          <h1 className="text-6xl sm:text-8xl md:text-[10rem] font-bold text-white tracking-tighter leading-[0.8] mb-12 font-outfit animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-100 uppercase">
            Power &amp; <br />
            <span className="amber-shimmer italic font-black">Dominance.</span>
          </h1>

          <p className="text-lg md:text-2xl text-[#78716C] max-w-3xl mx-auto leading-relaxed mb-20 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200 font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
            ...
            <Button
              variant="outline"
              className="w-full sm:w-auto rounded-2xl px-14 py-9 text-lg font-bold border-white/5 bg-white/[0.02] backdrop-blur-3xl hover:bg-[#EAB308]/[0.05] hover:border-[#EAB308]/20 gap-3 text-[#FAFAF9] transition-all"
            >
              Add to Server
        ...
        <div className="max-w-6xl mx-auto mt-40 relative group animate-in fade-in zoom-in-95 duration-1000 delay-500">
          <div className="absolute -inset-4 bg-gradient-to-r from-[#EAB308]/15 to-transparent rounded-[60px] blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
          <div className="relative bg-[#0C0A09] border border-[#EAB308]/10 rounded-[50px] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.8)]">
            <div className="h-16 border-b border-white/[0.03] flex items-center justify-between px-10 bg-white/[0.01]">
              <div className="flex items-center gap-3">
                <div className="h-3 w-3 rounded-full bg-[#EAB308]/40" />
                <div className="h-3 w-3 rounded-full bg-white/10" />
                <div className="h-3 w-3 rounded-full bg-white/5" />
              </div>
              <div className="px-6 py-2 rounded-2xl bg-[#EAB308]/[0.04] border border-[#EAB308]/10 text-[10px] font-black text-[#78716C] tracking-[0.2em] uppercase">
                aizen.core // guardian_node_01
              </div>
              <div className="w-12" />
            </div>
            <div className="aspect-[16/10] p-16 flex flex-col gap-16 relative overflow-hidden bg-gradient-to-br from-[#0C0A09] to-[#111420]">
              ...
              <div className="grid grid-cols-3 gap-10 z-10">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-40 bg-white/[0.02] border border-[#EAB308]/[0.06] rounded-[40px] p-8 space-y-6 hover:border-[#EAB308]/20 transition-colors">
                    <div className="h-10 w-10 rounded-2xl bg-[#EAB308]/[0.08] border border-[#EAB308]/15" />
                    <div className="h-4 w-2/3 bg-white/5 rounded-lg" />
                    <div className="h-3 w-1/2 bg-white/[0.02] rounded-lg" />
                  </div>
                ))}
              </div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] h-[90%] bg-[#EAB308]/[0.015] blur-[150px] pointer-events-none" />
            </div>
          </div>
        </div>
      </header>
      ...
      <section id="features" className="py-48 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-12 px-4">
            <div className="max-w-3xl">
              <h2 className="text-6xl md:text-8xl font-bold text-white tracking-tighter font-outfit mb-8 uppercase italic leading-none">
                Elite-Scale <br /><span className="text-amber-gradient not-italic">Infrastructure.</span>
              </h2>
              <p className="text-2xl text-[#78716C] font-medium leading-relaxed">
            ...
            <div className="flex items-center gap-10 pb-4">
              <div className="text-right">
                <p className="text-[10px] font-black uppercase text-[#78716C] tracking-[0.3em] mb-3">Ping Latency</p>
                <p className="text-5xl font-black text-[#EAB308] font-outfit">12ms</p>
              </div>
              <div className="h-16 w-[1px] bg-white/5" />
              <div className="text-right">
                <p className="text-[10px] font-black uppercase text-[#78716C] tracking-[0.3em] mb-3">Global Uptime</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Neuro-Security", desc: "Contextual AI analysis detects raids and token-logging attempts in real-time.", icon: ShieldCheck, color: "bg-[#EAB308]/10 border-[#EAB308]/20 text-[#EAB308]" },
              ...
              { title: "Real-time Flux", desc: "Watch server events live with zero-latency WebSocket data streaming.", icon: Activity, color: "bg-[#EAB308]/5 border-[#EAB308]/10 text-[#EAB308]/70" },
              ...
              <div key={i} className="group glass border-white/5 p-12 rounded-[50px] hover:border-[#EAB308]/25 transition-all duration-700 relative overflow-hidden">
                <div className="absolute top-0 right-0 p-12 opacity-0 group-hover:opacity-5 scale-50 group-hover:scale-110 transition-all duration-1000">
                  <feature.icon className="h-64 w-64 text-[#EAB308]" />
                </div>
                ...
                <p className="text-[#78716C] leading-relaxed font-bold relative z-10 group-hover:text-[#A09060] transition-colors uppercase text-[10px] tracking-[0.2em]">{feature.desc}</p>
                <div className="mt-8 h-[2px] w-0 bg-gradient-to-r from-[#EAB308] to-[#92400E] group-hover:w-full transition-all duration-700" />
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="architecture" className="py-48 px-6 bg-white/[0.008]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="space-y-12">
            <div className="inline-flex px-4 py-1.5 rounded-full bg-[#EAB308]/10 border border-[#EAB308]/20 text-[#EAB308] text-[10px] font-black uppercase tracking-[0.3em]">
              The Stack
            </div>
            ...
            <p className="text-xl text-[#78716C] leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-8">
              {[
                ...
                <div key={i} className="space-y-4 p-6 rounded-[30px] border border-[#EAB308]/[0.06] hover:bg-[#EAB308]/[0.02] hover:border-[#EAB308]/15 transition-colors">
            ...
            <div className="h-[80%] w-[80%] border-2 border-[#EAB308]/[0.08] rounded-full animate-[spin_60s_linear_infinite] flex items-center justify-center relative">
              ...
              <div className="h-[70%] w-[70%] border border-[#EAB308]/[0.06] rounded-full animate-[spin_40s_linear_infinite_reverse] flex items-center justify-center">
                ...
                <div className="h-[60%] w-[60%] border border-[#EAB308]/[0.04] rounded-full animate-[spin_20s_linear_infinite] flex items-center justify-center">
                  <Bot className="h-20 w-20 text-[#EAB308]/30 group-hover:text-[#EAB308] transition-all duration-700 group-hover:scale-125" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-32 space-y-6">
            <h2 className="text-6xl md:text-8xl font-bold text-white tracking-tighter font-outfit uppercase">
              The Arsenal <br /><span className="amber-shimmer italic">Complete.</span>
            </h2>
            <p className="text-2xl text-[#78716C] max-w-3xl mx-auto font-medium lowercase">Every module you need. Redefined for the modern era.</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="group p-8 rounded-[40px] bg-white/[0.01] border border-white/[0.03] hover:bg-[#EAB308]/[0.02] hover:border-[#EAB308]/15 transition-all duration-500">
                <div className="h-14 w-14 rounded-2xl bg-white/[0.03] flex items-center justify-center mb-6 group-hover:bg-[#EAB308]/10 transition-colors">
                  <mod.icon className="h-6 w-6 text-[#78716C] group-hover:text-[#EAB308] transition-colors" />
                </div>
      ...
      {/* ── Network Section ───────────────────────────────────── */}
      <section id="network" className="py-48 px-6 bg-[#EAB308]/[0.008] relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-24">
            <div className="flex-1 space-y-12">
              <h2 className="text-6xl md:text-8xl font-bold text-white tracking-tighter font-outfit uppercase">
                Global <br /><span className="text-[#EAB308]">Reach.</span>
              </h2>
              <p className="text-2xl text-[#78716C] leading-relaxed font-medium">
              ...
              <div className="space-y-8">
                {[
                  ...
                  <div key={i} className="flex items-center gap-8">
                    ...
                    <div className="h-[1px] flex-1 bg-[#EAB308]/10" />
                    <div className="text-[11px] font-black uppercase text-[#EAB308] tracking-[0.3em]">{item.label}</div>
                  </div>
                ))}
              </div>
            </div>
            <div className="flex-1 relative group">
              <div className="absolute inset-0 bg-[#EAB308]/10 blur-[150px] opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
              <div className="aspect-square bg-[#0C0A09] border border-[#EAB308]/10 rounded-[60px] p-12 relative overflow-hidden flex items-center justify-center">
                <Globe className="h-64 w-64 text-[#EAB308]/10 animate-pulse" />
      ...
      <section className="py-48 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-24">
            ...
            <p className="text-[#78716C] font-bold uppercase tracking-widest text-xs">Frequently Asked Questions</p>
          </div>
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="p-10 rounded-[40px] border border-white/[0.03] hover:border-[#EAB308]/15 transition-all bg-white/[0.01] group">
                <h4 className="text-xl font-bold text-white mb-6 font-outfit uppercase tracking-tight flex items-center gap-4">
                  <div className="h-2 w-2 rounded-full bg-[#EAB308] opacity-20 group-hover:opacity-100 transition-all animate-amber-pulse" />
                  {item.q}
                </h4>
                <p className="text-[#78716C] font-bold leading-relaxed">{item.a}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-48 px-6">
        <div className="max-w-6xl mx-auto relative rounded-[80px] p-24 md:p-32 overflow-hidden text-center shadow-[0_40px_100px_rgba(0,0,0,0.7)]"
          ...
          <div className="relative z-10">
            ...
            <p className="text-2xl text-[#FAFAF9]/60 max-w-3xl mx-auto mb-20 font-medium">
      ...
      {/* ── Footer ─────────────────────────────────────────────── */}
      <footer className="py-32 border-t border-[#EAB308]/[0.06] bg-[#050508] relative z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-32">
            <div className="col-span-1 md:col-span-2 space-y-12">
              <div className="flex items-center gap-4 group">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-[#EAB308] to-[#92400E] flex items-center justify-center border border-white/10">
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-[#3A3020]">
                <li><Link href="#" className="hover:text-[#EAB308] transition-colors">GitHub Repository</Link></li>
                <li><Link href="/docs" className="hover:text-[#EAB308] transition-colors">Documentation</Link></li>
                <li><Link href="#" className="hover:text-[#EAB308] transition-colors">API References</Link></li>
              </ul>
            </div>
            <div className="space-y-8">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-white opacity-40">Identity</h4>
              <ul className="space-y-5 text-[11px] font-black uppercase tracking-widest text-[#3A3020]">
                <li><Link href="/privacy" className="hover:text-[#EAB308] transition-colors">Privacy Shield</Link></li>
                <li><Link href="/terms" className="hover:text-[#EAB308] transition-colors">Terms of Service</Link></li>
                <li><Link href="https://discord.gg/M8qJ9W7vBb" target="_blank" rel="noopener noreferrer" className="hover:text-[#EAB308] transition-colors">Discord Server</Link></li>
              </ul>
            </div>
          </div>
          <div className="pt-12 border-t border-[#EAB308]/[0.06] flex flex-col md:flex-row items-center justify-between gap-6 opacity-40">
            <p className="text-[#3A3020] text-[10px] font-black uppercase tracking-[0.4em]">
              © 2026 {BRAND} — All Rights Reserved
            </p>
            <div className="flex items-center gap-3 text-[10px] font-black text-[#EAB308] uppercase tracking-[0.3em]">
