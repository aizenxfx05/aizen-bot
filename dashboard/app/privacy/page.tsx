  ...
  return (
    <div className="min-h-screen bg-[#050508] text-[#FAFAF9] font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-[#EAB308]/[0.025] blur-[120px] rounded-full" />
      </div>
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/[0.03] bg-[#050508]/80 backdrop-blur-3xl px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-4 group">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-[#EAB308] to-[#92400E] flex items-center justify-center mr-4">
      ...
      <main className="relative z-10 pt-40 pb-32 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white font-outfit tracking-tighter uppercase mb-12 italic">
            Privacy <span className="text-amber-gradient not-italic">Policy.</span>
          </h1>
