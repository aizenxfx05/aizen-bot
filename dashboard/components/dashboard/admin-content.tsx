          ...
          <div className="p-8 flex-1 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea 
                ...
                className="w-full h-32 bg-white/[0.03] border border-white/5 rounded-2xl p-4 text-xs font-medium text-[#F3E8FF] focus:outline-none focus:ring-1 focus:ring-[#A855F7]/30 transition-all placeholder:text-[#382F48]"
