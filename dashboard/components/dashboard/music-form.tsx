...
export function MusicForm({ initialConfig, channels, guildId }: MusicFormProps) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="p-6 rounded-3xl bg-[#0C0B0F]/90 border border-[#EAB308]/15 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#EAB308]/[0.03] blur-[80px] rounded-full pointer-events-none" />

        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="h-14 w-14 rounded-2xl bg-[#EAB308]/10 border border-[#EAB308]/20 flex items-center justify-center text-[#EAB308] shadow-lg shadow-[#EAB308]/10">
          ...
          <div className="flex items-center gap-4 text-xs">
            <div className="px-4 py-2 rounded-xl bg-white/[0.02] border border-white/5 text-center">
              <p className="text-[10px] uppercase font-bold text-[#78716C] tracking-wider">Bitrate</p>
              <p className="text-sm font-black text-white font-outfit">384 kbps</p>
            </div>
            <div className="px-4 py-2 rounded-xl bg-white/[0.02] border border-white/5 text-center">
              <p className="text-[10px] uppercase font-bold text-[#78716C] tracking-wider">Latency</p>
              <p className="text-sm font-black text-[#EAB308] font-outfit">~12ms</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* 24/7 Mode Card */}
        <div className="p-8 rounded-3xl bg-[#0C0B0F]/90 border border-white/5 backdrop-blur-2xl shadow-xl flex flex-col justify-between space-y-6">
            ...
            <div className="flex items-center justify-between pb-6 border-b border-white/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#78716C]">Keep the bot permanently stationed in your voice channel.</p>
                </div>
              </div>
              <Switch
            ...
            <div className={cn("space-y-4 transition-all duration-300", !config.is_247 && "opacity-40 pointer-events-none")}>
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-300 uppercase tracking-wider flex items-center gap-2">
                  <Headphones className="h-3.5 w-3.5 text-[#EAB308]" />
                ...
                >
                  <SelectTrigger className="w-full h-12 bg-white/[0.02] border-white/5 rounded-xl font-medium text-white focus:ring-1 focus:ring-[#EAB308]/30">
                    <SelectValue placeholder="Select a voice channel..." />
                  </SelectTrigger>
                  <SelectContent className="bg-[#0C0B0F] border-white/10 text-white">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-300 uppercase tracking-wider flex items-center gap-2">
                  <Volume2 className="h-3.5 w-3.5 text-[#EAB308]" />
          ...
          <Button
            onClick={handleSave}
            disabled={saving}
            className="w-full bg-[#EAB308] hover:bg-[#F59E0B] text-black font-black uppercase tracking-wider rounded-xl py-6 shadow-lg shadow-[#EAB308]/20 gap-2 transition-all hover:scale-[1.01]"
          >
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 pb-6 border-b border-white/5">
              ...
              <div>
                ...
                <p className="text-xs text-[#78716C]">Stream seamlessly from your preferred platform.</p>
              </div>
            </div>
              ...
              {[
                ...
                <div key={platform.name} className="p-4 rounded-2xl bg-white/[0.02] border border-white/5 space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-wider text-[#78716C]">Supported</span>
                  </div>
                  <p className="text-xs font-bold text-white">{platform.name}</p>
                  <p className="text-[10px] text-[#78716C]">{platform.badge}</p>
                </div>
              ))}
            </div>
